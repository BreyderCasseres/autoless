...
public class IngresarInformacionFinancieraDelClienteMenorDeEdad implements Task
{
    private InformacionFinancieraData informacionFinancieraData;

    public IngresarInformacionFinancieraDelClienteMenorDeEdad(InformacionFinancieraData informacionFinancieraData) {
        this.informacionFinancieraData = informacionFinancieraData;
    }

    public static IngresarInformacionFinancieraDelClienteMenorDeEdad yOOrdenante(InformacionFinancieraData informacionFinancieraData)
    {
        return Tasks.instrumented(IngresarInformacionFinancieraDelClienteMenorDeEdad.class,informacionFinancieraData);
    }
