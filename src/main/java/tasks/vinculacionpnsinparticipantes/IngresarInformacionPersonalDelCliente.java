...
public class IngresarInformacionPersonalDelCliente implements Task
{
    private InformacionBasicaClienteData informacionBasicaClienteData;

    public IngresarInformacionPersonalDelCliente(InformacionBasicaClienteData informacionBasicaClienteData) {
        this.informacionBasicaClienteData = informacionBasicaClienteData;
    }

    public static IngresarInformacionPersonalDelCliente noPep(InformacionBasicaClienteData informacionBasicaClienteData)
    {
        return Tasks.instrumented(IngresarInformacionPersonalDelCliente.class,informacionBasicaClienteData);
    }
    ...
    public <T extends Actor> void performAs(T actor)
    {
        actor.attemptsTo(
            ...
            Click.on(CHBX_ENTIDADSCB),
            Click.on(CHBX_ENTIDADSOCIEDADFIDUCIARIA),
