...
public class IngresarRelacionesBancariasEntidadSoloBanco implements Task
{
    private InformacionBancariaData informacionBancariaData;

    public IngresarRelacionesBancariasEntidadSoloBanco(InformacionBancariaData informacionBancariaData) {
        this.informacionBancariaData = informacionBancariaData;
    }

    public static IngresarRelacionesBancariasEntidadSoloBanco delClienteOTercero(InformacionBancariaData informacionBancariaData)
    {
        return Tasks.instrumented(IngresarRelacionesBancariasEntidadSoloBanco.class,informacionBancariaData);
    }
