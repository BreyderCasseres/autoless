...
public class IngresarInformacionPersonalSoloEntidadFuduciaria implements Task
{
    private InformacionBasicaClienteData informacionBasicaClienteData;

    public IngresarInformacionPersonalSoloEntidadFuduciaria(InformacionBasicaClienteData informacionBasicaClienteData) {
        this.informacionBasicaClienteData = informacionBasicaClienteData;
    }

    public static IngresarInformacionPersonalSoloEntidadFuduciaria delCliente(InformacionBasicaClienteData informacionBasicaClienteData)
    {
        return Tasks.instrumented(IngresarInformacionPersonalSoloEntidadFuduciaria.class,informacionBasicaClienteData);
    }
