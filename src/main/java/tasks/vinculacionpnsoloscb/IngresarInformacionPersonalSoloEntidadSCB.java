...
public class IngresarInformacionPersonalSoloEntidadSCB implements Task
{
    private InformacionBasicaClienteData informacionBasicaClienteData;

    public IngresarInformacionPersonalSoloEntidadSCB(InformacionBasicaClienteData informacionBasicaClienteData) {
        this.informacionBasicaClienteData = informacionBasicaClienteData;
    }

    public static IngresarInformacionPersonalSoloEntidadSCB delCliente(InformacionBasicaClienteData informacionBasicaClienteData)
    {
        return Tasks.instrumented(IngresarInformacionPersonalSoloEntidadSCB.class,informacionBasicaClienteData);
    }
