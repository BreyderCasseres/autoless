...
public class SeleccionarProductosSoloEntidadSCB implements Task
{

    public static SeleccionarProductosSoloEntidadSCB porEntidad()
    {
        return Tasks.instrumented(SeleccionarProductosSoloEntidadSCB.class);
    }
