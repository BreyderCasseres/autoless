...
public class IngresarInformacionFinanciera implements Task
{
    private InformacionFinancieraData informacionFinancieraData;

    public IngresarInformacionFinanciera(InformacionFinancieraData informacionFinancieraData) {
        this.informacionFinancieraData = informacionFinancieraData;
    }

    public static IngresarInformacionFinanciera delClienteYOOrdenante(InformacionFinancieraData informacionFinancieraData)
    {
        return Tasks.instrumented(IngresarInformacionFinanciera.class,informacionFinancieraData);
    }
