...
public class IngresarInformacionPersonal implements Task
{
    ...
    public IngresarInformacionPersonal(InformacionBasicaClienteData informacionBasicaClienteData) {
        this.informacionBasicaClienteData = informacionBasicaClienteData;
    }

    public static IngresarInformacionPersonal delCliente(InformacionBasicaClienteData informacionBasicaClienteData)
    {
        return Tasks.instrumented(IngresarInformacionPersonal.class,informacionBasicaClienteData);
    }
